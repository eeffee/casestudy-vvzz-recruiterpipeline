...
c. -industry information: companies can be groupped by industry then analyze for sectors
...
b. MVP: Rule‑based weighted scoring – simple, no training data needed.
AI signals(future): Embeddings for semantic matching (job description talent experience), decision tree after collecting historical placement data.

Part 2.4 Hiring Intent

a. Signals : - when the job post is opened? 
